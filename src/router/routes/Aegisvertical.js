...
const AegisverticalRoutes = [
    {
        path: '/aegisvertical/email',
        exact: true,
        appLayout: true,
    ...
    {
        path: '/aegisvertical/email/:folder',
        exact: true,
        appLayout: true,
        className: 'email-application',
        component: lazy(() => import('../../views/apps/email')),
    ...
    {
        path: '/aegisvertical/email/label/:label',
        exact: true,
        appLayout: true,
        className: 'email-application',
        component: lazy(() => import('../../views/apps/email')),
    ...
    {
        path: '/aegisvertical/email/:filter',
        component: lazy(() => import('../../views/apps/email')),
        meta: {
            navLink: '/apps/email'
        }
...
export default AegisverticalRoutes
